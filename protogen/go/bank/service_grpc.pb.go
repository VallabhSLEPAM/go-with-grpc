...
type BankServiceClient interface {
	...
	TransferMultiple(ctx context.Context, opts ...grpc.CallOption) (grpc.ClientStreamingClient[TransferRequest, TransferResponse], error)
...
func (c *bankServiceClient) TransferMultiple(ctx context.Context, opts ...grpc.CallOption) (grpc.ClientStreamingClient[TransferRequest, TransferResponse], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type BankService_TransferMultipleClient = grpc.ClientStreamingClient[TransferRequest, TransferResponse]

func (c *bankServiceClient) CreateAccount(ctx context.Context, in *AccountRequest, opts ...grpc.CallOption) (*AccountResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
type BankServiceServer interface {
	...
	TransferMultiple(grpc.ClientStreamingServer[TransferRequest, TransferResponse]) error
...
func (UnimplementedBankServiceServer) TransferMultiple(grpc.ClientStreamingServer[TransferRequest, TransferResponse]) error {
	return status.Errorf(codes.Unimplemented, "method TransferMultiple not implemented")
}
func (UnimplementedBankServiceServer) CreateAccount(context.Context, *AccountRequest) (*AccountResponse, error) {
...
// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type BankService_TransferMultipleServer = grpc.ClientStreamingServer[TransferRequest, TransferResponse]
...
func _BankService_CreateAccount_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(BankServiceServer).CreateAccount(ctx, req.(*AccountRequest))
	}
	return interceptor(ctx, in, info, handler)
}
